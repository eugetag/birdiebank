...
export const metadata: Metadata = {
  title: "Bets — Golf Bet Ledger",
  description: "Step 3 of 3: choose the bets for this round.",
};
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-8 px-5 py-8 sm:px-8 sm:py-12">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-base leading-relaxed text-fairway-900/70">
            Toggle the bets you want to play and set the stakes. You can mix
            and match — every bet rolls into one ledger at the end.
          </p>
        </div>
